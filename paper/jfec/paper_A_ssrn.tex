...
sits $6$--$11\%$ above $h$ times the one-day variance in every year of
...
bootstrapped filtered paths $0.5\%$ (DM 2.5), on the same rows. The
...
(direct edge $+0.49\%$, DM 0.07); against the iterated benchmarks the
