...
$1\%$, $5.1$ at $2.5\%$), pooled-tail GARCH-EVT (DM $4.8$ and $6.8$; its bars come from the same-rows run of the Online Appendix, whose accuracy-layer baseline is within $0.0006$ of the one plotted) and FHS (DM $4.9$), together with the two
...
(direct edge $+0.49\%$, DM 0.07), as do the iterated benchmarks (DM at
most 0.3), and the calibration
