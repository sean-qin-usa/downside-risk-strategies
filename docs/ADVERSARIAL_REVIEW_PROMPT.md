...
6. Novelty. Against Zhang, Haerdle and Bommes (JFEC 2024), Patton-Ziegel-Chen (2019), the CAViaR line, and the global-vs-local forecasting literature (amortization = global models, long known in the M-competitions): what exactly is new? Argue the misspecification score is repackaged conditional kurtosis — a known predictor — with branding.
