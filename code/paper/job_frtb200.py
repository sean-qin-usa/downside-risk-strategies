# job_frtb200.py -- frtb_table_canonical.py rerun on the 200-name panel of Table 1 (names>=1500 obs, top 200), so the FRTB battery and the frontier share one panel. No other change. PREDICTION (2026-09-24): the ordering of Table 3 is unchanged; the residual-hybrid rows and GARCH-t move by under 0.002 pinball; Kupiec pass sets at 1% may change because the pooled test gains 40% more observations.
...
json.dump(out,open(os.path.join(P,"frtb_table_200_results.json"),"w"),indent=2)
