...
(Table~6 of the paper). Date-clustered tests in the table notes. The
GJR bar predates the skew-$t$ correction of Table~6's note; the
corrected pooled battery row passes both 99\% tests.}
\label{fig:passrates}
\end{figure}
\clearpage
\begin{figure}[htbp]
...
in the main text ($0.4\%\!\to\!1.4\%$) come from the stress battery
and are smaller --- the designs differ and are labeled where quoted.}
\label{fig:horizon}
\end{figure}
\clearpage
\begin{figure}[htbp]
