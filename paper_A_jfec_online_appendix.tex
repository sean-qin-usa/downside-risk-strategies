...
as a log-return artifact on near-zero and negative prices --- refit on
price differences, GARCH wins PJM (DM $-2.73$) --- so the survivor
count the text quotes is seven.
\end{tablenotes}
\end{threeparttable}
\end{table}
