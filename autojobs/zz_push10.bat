...
set LOG=%PROJ%\zz_push10_log.txt
cd /d "%PROJ%"
echo === lock sweep === > "%LOG%"
...
git add -A > nul 2>> "%LOG%"
git commit -m "Horizon-holdout era-dependence folded; absorb v2 rerun" -m "Co-Authored-By: Claude Fable 5 <noreply@anthropic.com>" -m "Claude-Session: https://claude.ai/code/session_01PaysugvHD2tgCJvXLSscWa" >> "%LOG%" 2>&1
