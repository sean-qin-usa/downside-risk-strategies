...
git add -A > nul 2>> "%LOG%"
git commit -m "FZ addendum (no-conf variant) + frtb-holdout paper fold" -m "Co-Authored-By: Claude Fable 5 <noreply@anthropic.com>" -m "Claude-Session: https://claude.ai/code/session_01PaysugvHD2tgCJvXLSscWa" >> "%LOG%" 2>&1
