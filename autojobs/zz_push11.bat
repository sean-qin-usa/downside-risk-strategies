...
set LOG=%PROJ%\zz_push11_log.txt
cd /d "%PROJ%"
echo === lock sweep === > "%LOG%"
...
git add -A > nul 2>> "%LOG%"
git commit -m "Absorption result folded: reweighted-FHS fails, pooling is the precondition; v09-04f" -m "Co-Authored-By: Claude Fable 5 <noreply@anthropic.com>" -m "Claude-Session: https://claude.ai/code/session_01PaysugvHD2tgCJvXLSscWa" >> "%LOG%" 2>&1
