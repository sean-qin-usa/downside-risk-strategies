...
set LOG=%PROJ%\zz_push14_log.txt
cd /d "%PROJ%"
echo === lock sweep === > "%LOG%"
...
git add -A > nul 2>> "%LOG%"
git commit -m "JFEC compliance: 97-word abstract (long version preserved for SSRN); journal requirements doc" -m "Co-Authored-By: Claude Fable 5 <noreply@anthropic.com>" -m "Claude-Session: https://claude.ai/code/session_01PaysugvHD2tgCJvXLSscWa" >> "%LOG%" 2>&1
