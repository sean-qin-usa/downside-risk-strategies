...
ES the average loss beyond it. Three
...
the 2020 crash, widens the band out of era (breach $1.7\%$ against the $2.5\%$ target) and gives back the FZ0 advantage there. The static-overlay variant loses to GARCH-$t$ on the 2.5\% joint score (DM $-2.0$), and the concession is largest in the top misspecification decile, where the static shift's joint-score deficit reaches DM $-7.1$. The coverage
