...
edge compresses to $+0.32\%$ (DM 0.8), within noise; this check uses the returns-space learner of the frozen holdout specification. Stale benchmark parameters therefore do not
...
Christoffersen conditional coverage for $86\%$, and the date-clustered test passes at 99\% ($t=1.01$) and marginally at 97.5\% ($t=1.86$) while the raw residual-hybrid is rejected ($t=4.5$): the tail stages carry the regulatory
